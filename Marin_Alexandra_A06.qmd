...
[https://github.com/marinale5/Marin_Alexandra_201_A06](https://github.com/marinale5/Marin_Alexandra_201_A06)
...
```{r}
lebron_points_indexing <- player_info[["LJ"]][["points"]]
...
mat_rand_rounded <- apply(mat_rand, MARGIN = 1:2, round_func)
...
```{r}
co_median_temps <- co_temps |> 
  pivot_longer(cols = jan:dec, names_to = "month", values_to = "temperature") |> 
  group_by(year) |> 
  summarize(median_temperature = median(temperature, na.rm = TRUE))

max_median_temp <- which.max(co_median_temps$median_temperature)
max_median_temp_year <- co_median_temps$year[max_median_temp]
max_median_temp_value <- co_median_temps$median_temperature[max_median_temp]

min_median_temp <- which.min(co_median_temps$median_temperature)
min_median_temp_year <- co_median_temps$year[min_median_temp]
min_median_temp_value <- co_median_temps$median_temperature[min_median_temp]

paste0("The maximum median annual temperature of ", max_median_temp_value, " occurred in ", max_median_temp_year,
    " and the minimum median annual temperature of ", min_median_temp_value, " occurred in ", min_median_temp_year, ".")
